...
def insert():
    ...
    return render_template('insert.html', sciences=sciences, executives=executives, programs=programs, researchers=researchers, organizations=organizations, msg=msg)
